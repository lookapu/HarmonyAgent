...
pub fn run() {
    tauri::Builder::default()
        ...
        .invoke_handler(tauri::generate_handler![
            ...
            agent::sandbox::verify_native_sandbox_boundary,
            ...
            commands::team_sharing::preview_team_share,
            commands::team_sharing::apply_team_share,
            commands::team_sharing::revert_team_share,
            commands::team_sharing::list_team_share_imports,
            commands::team_sharing::list_team_share_changes,
            commands::team_sharing::export_team_share,
            commands::team_sharing::run_team_eval_set,
            commands::team_sharing::list_team_eval_sets,
            commands::reproduction_bundle::preview_reproduction_bundle,
            commands::reproduction_bundle::generate_reproduction_bundle,
            commands::reproduction_bundle::list_reproduction_bundles,
            commands::reproduction_bundle::validate_reproduction_bundle,
