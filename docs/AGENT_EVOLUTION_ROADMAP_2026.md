...
- [ ] Tree-sitter/ArkTS 容错 AST 层与依赖/影响图（AST、`contains`、语法级 `extends/implements`、同文件唯一目标、相对命名 import 及根 `tsconfig` path alias 查询时绑定已完成；HarmonyOS 包映射、re-export 与 calls 待完成）；
