...
## 40. 参考文档改用目录树精确查表、种子库空库重建与 §39 数字更正（2026-09-18）

第 40 批：把「模块名 → 参考文档」从猜 slug 换成文档目录树查表，并发现 §39 记的种子库数字被**两代数据叠加**误导，出厂种子库改为空库重建。
