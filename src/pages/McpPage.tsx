    ...
    <div>
      <div className="flex items-center justify-between mb-4">
        <div>
          ...
          <p className="text-xs text-[var(--text-secondary)] mt-1">{t('mcp.templateHint')}</p>
        </div>
        <button
      ...
      {showForm && (
        <div className="bg-[var(--bg-secondary)] border border-[var(--border)] rounded-2xl p-4 mb-6 space-y-4 animate-fade-in-up">
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 gap-3">
            ...
            <div className="space-y-1.5">
              ...
              <textarea
                ...
                className="w-full px-3 py-2 bg-[var(--bg-card)] border border-[var(--border)] rounded-lg text-[13px] font-mono text-[var(--text-primary)] placeholder:text-[var(--text-muted)] focus:outline-none focus:border-[var(--accent)] resize-y"
              />
            </div>
          </div>
      ...
      <div className="bg-[var(--bg-secondary)] border border-[var(--border)] rounded-2xl p-4 mb-6 space-y-3 animate-fade-in-up">
        ...
        <div className="flex gap-2">
          <input
            ...
            className="flex-1 h-9 px-3 bg-[var(--bg-card)] border border-[var(--border)] rounded-lg text-[13px] font-mono text-[var(--text-primary)] placeholder:text-[var(--text-muted)] focus:outline-none focus:border-[var(--accent)]"
          />
          <button
            onClick={handleFetch}
            disabled={!fetchUrl.trim() || fetching}
            className="px-4 h-9 rounded-[10px] bg-[var(--accent)] text-white text-[13px] font-medium hover:bg-[var(--accent-hover)] transition-colors disabled:opacity-40 disabled:cursor-not-allowed shrink-0"
          >
        ...
        {drafts && (
          <div className="space-y-2">
            ...
            {drafts.map((d) => (
              <div key={d.name} className="flex items-center justify-between gap-3 bg-[var(--bg-card)] border border-[var(--border)] rounded-lg px-3 py-2">
      ...
      <div className="space-y-3">
        ...
        {visibleServers.map((s) => (
          <div key={s.id} className="bg-[var(--bg-secondary)] border border-[var(--border)] rounded-lg p-4 flex items-center justify-between gap-3">
            <div className="min-w-0">
